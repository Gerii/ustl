...
public:
    ...
    inline void     push_front (const T& v)   { this->insert (begin(), v); } //TODO this only in sweb
    inline void     pop_front (void)    { this->erase (begin()); } //TODO this only in sweb
    ...
    inline iterator find_if(Constraint constraint) { return ::ustl::find_if (*this, constraint); } //TODO great for upstream?
    ...
    template <typename Constraint> //TODO great for upstream?
